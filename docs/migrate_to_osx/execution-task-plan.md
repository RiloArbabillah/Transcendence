...
- Karena itu blocker aktif belum dinyatakan selesai, tetapi sudah direklasifikasi: crash intro-effect yang sebelumnya direproduksi lewat backtrace kini paling mungkin berasal dari object-reference yang diberikan ke script hit-effect atau dari jalur runtime yang lebih jarang daripada smoke run batch saat ini. Validasi manual visual/interaktif menu masih tetap dibutuhkan.
